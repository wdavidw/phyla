...
## Enable JMX Server
      ...
      service.deps.hbase_rs.options.opts['com.sun.management.jmxremote.authenticate'] ?= 'false'
      service.deps.hbase_rs.options.opts['com.sun.management.jmxremote.ssl'] ?= 'false'
      service.deps.hbase_rs.options.opts['com.sun.management.jmxremote.port'] ?= '9016'
...
configure JMX Exporter to scrape HBase RegionServer metrics.
      ...
      options.config['hostPort'] ?= "#{service.deps.hbase_rs.node.fqdn}:#{service.deps.hbase_rs.options.opts['com.sun.management.jmxremote.port']}"
