...
## Enable JMX Server
      ...
      service.deps.yarn_rm.options.opts.java_properties['com.sun.management.jmxremote.authenticate'] ?= 'false'
      service.deps.yarn_rm.options.opts.java_properties['com.sun.management.jmxremote.ssl'] ?= 'false'
      service.deps.yarn_rm.options.opts.java_properties['com.sun.management.jmxremote.port'] ?= '9015'
...
[JMX Exporter][jmx_exporter] repository.
      ...
      options.config['hostPort'] ?= "#{service.deps.yarn_rm.node.fqdn}:#{service.deps.yarn_rm.options.opts.java_properties['com.sun.management.jmxremote.port']}"
