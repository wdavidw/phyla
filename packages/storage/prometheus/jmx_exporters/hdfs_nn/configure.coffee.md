...
## Identities
      ...
      options.hdfs_user ?= mixme service.deps.hdfs_nn.options.user
      options.hdfs_group ?= mixme service.deps.hdfs_nn.options.group
...
## Enable JMX SSL
      ...
      options.ssl = mixme service.deps.ssl, service.deps.hdfs_nn.options.ssl
      if !!options.ssl
