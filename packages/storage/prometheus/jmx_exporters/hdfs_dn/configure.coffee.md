...
## Identities
      ...
      options.hdfs_user ?= mixme service.deps.hdfs_dn.options.user
      options.hdfs_group ?= mixme service.deps.hdfs_dn.options.group
...
## Enable JMX SSL
      ...
      options.ssl = mixme service.deps.ssl, service.deps.hdfs_dn.options.ssl
      if !!options.ssl
