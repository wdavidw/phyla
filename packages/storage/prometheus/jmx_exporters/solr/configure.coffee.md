...
## Identities
      ...
      options.hdfs_user ?= mixme service.deps.solr.options.user
      options.hdfs_group ?= mixme service.deps.solr.options.group
...
## Enable JMX SSL
      ...
      options.ssl = mixme service.deps.ssl, service.deps.solr.options.ssl
      if !!options.ssl
