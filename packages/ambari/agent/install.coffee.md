...
## Wait
      ...
      @call 'ryba-ambari-takeover/ambari/server/wait', rest: options.wait_ambari_rest
...
## Non-Root
      ...
      @file.download
        source: "#{__dirname}/../resources/script.py"
        target: '/usr/lib/ambari-agent/lib/resource_management/libraries/script/script.py'
        local: true
        backup: true
